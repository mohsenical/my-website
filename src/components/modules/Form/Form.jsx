...
function Form() {
    return (
        <form className="grid gap-5 w-[90%] lg:w-[80%] mx-5">
            ...
            <button className="h-10 rounded-xl text-lg text-white/60 bg-white/30 hover:bg-slate-600 dark:hover:bg-green-900 border border-white/40 hover:border-slate-800 dark:hover:border-green-800 cursor-pointer transition-all">ارسال</button>
        </form>
    )
}
