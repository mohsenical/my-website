...
function HeaderSection() {
  return (
    <>
      <div className="flex justify-center h-[42rem] w-full md:px-2 lg:px-15 xl:px-30 bg-white dark:bg-black shadow overflow-hidden">
        <div
          ...
          <div className="flex flex-col justify-center items-center md:mt-20 space-y-2 backdrop-blur-xl bg-white/40 dark:bg-black/50 p-5 rounded-2xl">
            ...
            <div className="w-full border-r-2 border-r-sky-900 dark:border-r-green-700 lg:px-2">
