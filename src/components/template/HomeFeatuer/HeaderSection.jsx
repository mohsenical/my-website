...
function HeaderSection() {
  return (
    <>
      <div className="flex justify-center h-[45rem] w-full md:px-2 lg:px-15 xl:px-30 relative bg-black overflow-hidden">

        <div className="flex flex-col justify-center items-center md:items-start md:h-[38rem] lg:h-[40rem] xl:h-[45rem] w-[100%] md:w-[58%] mt-15 pt-75 md:pt-50 0 bg-[url(/Image/AvatarBackground.png)] bg-no-repeat bg-center bg-cover md:bg-none">
